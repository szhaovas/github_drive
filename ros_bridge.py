...
class UrRosBridge:
    ...
    def set_joint_position(self, goal_joint_position):
        ...
        rospy.logwarn('Setting joint positions:')
        rospy.logwarn(goal_joint_position)
    ...
    def get_moveit_plan(self, moveit_goal):
        ...
        goal_pose.position.x = goal_list[0]
        goal_pose.position.y = goal_list[1]
        goal_pose.position.z = goal_list[2]
        goal_pose.orientation.x = goal_list[3]
        goal_pose.orientation.y = goal_list[4]
        goal_pose.orientation.z = goal_list[5]
        goal_pose.orientation.w = goal_list[6]

        self.move_group.set_pose_target(goal_pose)
        rospy.logwarn('Received goal x:%.3f y:%.3f z:%.3f', goal_pose.position.x, goal_pose.position.y, goal_pose.position.z)
